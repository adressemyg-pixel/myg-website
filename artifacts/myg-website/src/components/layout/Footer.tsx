    ...
    <footer className="bg-primary text-primary-foreground py-16 border-t border-primary-foreground/10">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          <h4 className="font-serif text-lg font-semibold tracking-wide uppercase text-primary-foreground/60">Navigation</h4>
        ...
        <div className="space-y-4">
          <h4 className="font-serif text-lg font-semibold tracking-wide uppercase text-primary-foreground/60">Connect</h4>
      ...
      <div className="container mx-auto px-4 mt-16 pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row items-center justify-between text-sm text-primary-foreground/60">
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          ...
          <span>|</span>
          <span className="font-semibold text-primary-foreground">EN</span>
        </div>
      </div>
    </footer>
  );
